...
function HarmonicSteadyState.plot_phase_diagram(res::Result, class::String; kwargs...)
...
Other kwargs are passed onto Plots.gr()
"""
function HarmonicSteadyState.plot_spaghetti(
    res::Result{D};
    x::String,
    y::String,
    z::String,
    ...
    if class == "default"
        if not_class == [] # plot stable full, unstable dashed
            p = HarmonicSteadyState.plot_spaghetti(
