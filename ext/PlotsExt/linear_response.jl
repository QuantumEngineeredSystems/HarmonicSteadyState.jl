...
"""
function HarmonicSteadyState.plot_linear_response(
    res::Result{D},
    nat_var::Num,
    branch::Int;
    Ω_range,
...
"""
function HarmonicSteadyState.plot_rotframe_jacobian_response(
    res::Result{D,S,P},
    branch::Int;
    Ω_range,
    logscale=true,
...
```
"""
function HarmonicSteadyState.plot_eigenvalues(
    res::Result{D,S,P},
    branch::Int;
    class=["physical"],
    type::Symbol=:imag,
